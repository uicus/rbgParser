...
EXEC = rbg2gdl
OBJECTS = src/options.o src/token.o src/message.o src/slice.o src/macro_bank.o src/slice_iterator.o src/parser_helpers.o src/game_board.o src/parsed_game.o src/game_items.o
