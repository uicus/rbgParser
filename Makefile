...
EXEC = rbgParser
OBJECTS = src/options.o src/token.o src/message.o src/slice.o src/macro_bank.o src/slice_iterator.o src/parser_helpers.o src/printer_helpers.o src/straightness_helpers.o src/declarations.o src/game_board.o src/shift.o src/ons.o src/offs.o src/assignments.o src/switch.o src/pure_bracketed_move.o src/bracketed_move.o src/pure_concatenation.o src/concatenation.o src/modifier_block.o src/pure_sum.o src/sum.o src/move_condition.o src/comparison.o src/negatable_condition.o src/conjunction.o src/alternative.o src/condition_check.o src/game_move.o src/parsed_game.o src/game_items.o
